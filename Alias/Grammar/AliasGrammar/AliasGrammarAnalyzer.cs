...
namespace Veda.Plugins.Alias.Grammar {
     ...
     * parser.</remarks>
     */
    internal abstract class AliasGrammarAnalyzer : Analyzer {
        ...
        public override void Enter(Node node) {
            switch (node.Id) {
            case (int) AliasGrammarConstants.STRING:
                EnterString((Token) node);
                break;
            case (int) AliasGrammarConstants.TEXT:
                EnterText((Token) node);
                break;
            case (int) AliasGrammarConstants.PARAMETER:
                EnterParameter((Token) node);
                break;
            case (int) AliasGrammarConstants.COMMAND_START:
                EnterCommandStart((Token) node);
                break;
            case (int) AliasGrammarConstants.COMMAND_END:
                EnterCommandEnd((Token) node);
                break;
            case (int) AliasGrammarConstants.COMMAND_SEPARATOR:
                EnterCommandSeparator((Token) node);
                break;
            case (int) AliasGrammarConstants.ALIAS:
                EnterAlias((Production) node);
                break;
            case (int) AliasGrammarConstants.COMMAND:
                EnterCommand((Production) node);
                break;
            case (int) AliasGrammarConstants.EXPRESSION:
        ...
        public override Node Exit(Node node) {
            ...
            case (int) AliasGrammarConstants.ALIAS:
                return ExitAlias((Production) node);
            case (int) AliasGrammarConstants.COMMAND:
         ...
         * discovered errors</exception>
         */
        public virtual void EnterAlias(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitAlias(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildAlias(Production node, Node child) {
            node.AddChild(child);
        }
