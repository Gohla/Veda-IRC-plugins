...
namespace Veda.Plugins.Channel
{
    ...
    {
        [Command(Description = "Joins given channel."), Permission(Group.Administrator, Allowed = true), 
        ...
        [Command(Description = "Parts given channel."), Permission(Group.Administrator, Allowed = true),
            Permission(Group.Owner, Allowed = true)]
